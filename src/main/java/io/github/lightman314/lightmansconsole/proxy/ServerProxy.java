...
public class ServerProxy extends Proxy{
    ...
    public void initializeJDA() throws LoginException
    {
    	...
    	if(initialized)
    	{
    		LightmansConsole.LOGGER.warn("Attempting to initialize the JDA twice.");
    		return;
    	}
    	initialized = true;
    	...
    	//Build the JDA
    	LightmansConsole.LOGGER.info("Attempting to build the JDA.");
    	...
    	LightmansConsole.LOGGER.info("Waiting for the JDA to finish the log in process.");
    	try {
			jda.awaitReady();
		} catch (InterruptedException e) {
			e.printStackTrace();
		}
    	LightmansConsole.LOGGER.info("JDA has successfully logged in.");
    }
	...
	public void addListener(Object listener)
	{
		...
		else
		{
			...
			LightmansConsole.LOGGER.info("Added JDA listener of type " + listener.getClass().getName());
		}
	}
